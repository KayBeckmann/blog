...
Ich habe in den letzten Wochen den Blog sehr vernachlässigt. Dabei fing das am Anfang des Jahres so gut an.

## Aufgabenübersicht

| Priorität | Aufgaben                    | Status  | Deadline | Verzögerungsstatus |
| --------- | --------------------------- | ------- | -------- | ------------------ |
| Niedrig   | [Tracker](#tracker)         | NEU  | Dezember   | in Bearbeitung            |
| offen     | [Kleingewerbe](#Kleingewerbe) | wartend | offen    | wartend            |
...
Alle meine Projekte sind in den letzten Wochen sehr stark vernachlässigt worden.
Der Verkauf des Hauses hat viele Ressourcen gebunden, weshalb alle anderen Projekte warten mussten.
